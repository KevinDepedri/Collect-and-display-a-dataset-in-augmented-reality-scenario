...
Here is an example of feature points:<br/>
...
In the image below it is shown the matching between keypoints from two different perspectives of the same image.<br/>
