...
2) Unzip the folder arcore-unity-extensions-master.zip in the project folder;

3) Open the project with Unity and open the SampleScene file. Once open an error could appear in the console (***Unable to resolve reference 'UnityEditor.iOS.Extensions.Xcode'***). Do not care about it, it will not affect the build of the application;
